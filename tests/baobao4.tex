%%
%% This is file `baobao4.bst',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% merlin.mbs  (with options: `ay,nat,nm-rev,jnrlst,aunm-semi,mcite,mct-1,mct-x3,keyxyr,dt-beg,yr-par,yrp-x,note-yr,volp-sp,num-xser,jnm-x,bkpg-x,add-pub,pre-pub,edparxc,in-col,ppx,ed,xedn,amper,and-xcom,url,url-blk,nfss,')
%% ----------------------------------------
%% *** JPR ***
%% 
...
FUNCTION {format.trick}
{
    ...
    fm empty$ {
       ...
       ss #1 "{vv~}{ll}{, jj}{, ff}" format.name$
        ...
        %% string has length 1
        tt text.length$ #3 > { %% If there was a medium name
